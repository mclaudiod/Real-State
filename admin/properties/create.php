<?php
    ...
    if($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        if(empty($errors)) {
            ...
            $query = "INSERT INTO properties (title, price, img, description, rooms, wc, parking, created, idagent) VALUES ('$title', '$price', '$imageName', '$description', '$rooms', '$wc', '$parking', '$created', '$agentid')";
